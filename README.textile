...
* "emmet-vim":http://www.vim.org/scripts/script.php?script_id=2981 - powerful way for HTML abbreviations (learn here: http://code.google.com/p/zen-coding/). Type abbreviation and press Ctrl+Y+comma (c-y ,)
...
<pre><code>
git clone git://github.com/atomsfat/vimfiles.git ~/.vim
</pre></code>
